...
Your Brick **PPPE** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/pppe/__init__.py` and add the `@brick` decorator.
```python
# bricks/pppe/__init__.py
...
your brick is created under the `bricks/pppe` folder that contains the following files:
